...
## Multi-level Models & Exchangability

Randomization assumes

- IDD 
- Exchangability of observations under the null hypothesis
- Grouping variables will often change the unit of exchangability
...
output |>
  ...
  annotate("text", x = -2.5, y = 60, label = paste0("P = ",round(empp,4)), size = 6)

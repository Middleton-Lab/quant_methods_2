...
- [R for Data Science](https://r4ds.had.co.nz/) Grolemund and Wickham [-@Grolemund2017-jh]
- [ggplot2](https://ggplot2-book.org/) Wickham [@Wickham2016-tm], *In-progress* 3rd edition
- [Modern Data Science with R](https://mdsr-book.github.io/mdsr2e/) Baumer et al. [-@Baumer2021-nm]
- [Fundamentals of Data Visualization](https://clauswilke.com/dataviz/index.html) Wilke [-@Wilke2019-il]
- [Data Visualization: A Practical Introduction](https://socviz.co/index.html#preface) Healy [-@Healy2018-cx]

...
- Don't choose the "best" and pretend it was the only model you fit
    - Combine models for analysis or prediction
...
```{r}
plot_grid(p1 + labs(title = paste0("fm1: ", round(mw3[1], 3))),
          p2 + labs(title = paste0("fm1: ", round(mw3[2], 3))),
          p3 + labs(title = paste0("fm1: ", round(mw3[3], 3))),
          p4 + labs(title = paste0("fm1: ", round(mw3[4], 3))),
          p5 + labs(title = paste0("fm1: ", round(mw3[5], 3))),
          ncol = 3)
```

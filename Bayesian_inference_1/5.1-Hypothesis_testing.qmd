...
Many visualizations in the [`see` package](https://easystats.github.io/see/articles/bayestestR.html)
...
- Analogous to generalized linear hypothesis tests (`glht()` in `multcomp`)

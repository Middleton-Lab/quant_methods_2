...
dbinom(9, 71, prob = 0.5)
dbinom(9, 71, prob = 0.25)
dbinom(9, 71, prob = 0.1)
```
...
Daniel Lakens: [Inference for a single confidence interval](https://lakens.github.io/statistical_inferences/confint.html#singleCI)

...
- Kruschke JK, Liddell TM. 2018a. The Bayesian New Statistics: Hypothesis testing, estimation, meta-analysis, and power analysis from a Bayesian perspective. *Psychon Bull Rev* 25:178–206.
- Kruschke JK, Liddell TM. 2018b. Bayesian data analysis for newcomers. *Psychon Bull Rev* 25:155–177.
...
6. Writing methods and results from Bayesian regression
...
- Missing data and modeling uncertainty
- Custom functions

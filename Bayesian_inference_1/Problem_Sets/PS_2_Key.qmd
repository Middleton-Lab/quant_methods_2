...
Make a scatter plot of sigma vs. mu from all the posterior samples:
...
> It looks totally random, like a perfect bivariate normal. There is no apparent structure or correlation between the samples. This doesn't always happen when one of the variables in a standard deviation. Since sd is bounded at 0, it's often not normally distributed in the posterior.

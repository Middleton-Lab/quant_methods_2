...
Outcome variable distributions *do not* have to match predictor distributions (priors).

- Outcome variables are usually linear models of predictors
    - Even transformed outcome variables (link functions)
- Predictors are often normally distributed (but they don't have to be)
    - Many biological processes result in normal distributions
...
- $\beta_0$: $\geq$ 0 (DBH at age = 0), use domain knowledge
- $\beta_1$: $\geq$ 0 (DBH increases with age), use domain knowledge
